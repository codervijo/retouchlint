    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="container-page py-12 flex-1">
        <div className="flex items-end justify-between flex-wrap gap-4">
          ...
          <a href="/projects/new" className="inline-flex items-center rounded-md bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground hover:bg-primary/90">
            + New listing
          </a>
        </div>
                  ...
                  return (
                    <tr key={p.id} className="border-t border-border hover:bg-secondary/30">
                      ...
                      <td className="px-5 py-4 text-right">
                        <a href={`/projects/view?id=${p.id}`} className="text-foreground hover:underline">Open →</a>
                      </td>
                    </tr>
                  );
                })}
...
function EmptyState() {
  return (
    <div className="mt-10 rounded-xl border border-dashed border-border bg-secondary/30 p-16 text-center">
      ...
      <a href="/projects/new" className="mt-5 inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90">
